...
public class BankAccount {
    ...
    try (FileInputStream fis = new FileInputStream(text);
        ...
        while (fileScanner.hasNextLine()) {
            ...
            String accountHolder1 = newName + Person.DELIM + gender + Person.DELIM +
                    newAge + Person.DELIM + newHeight + Person.DELIM +
                    newWeight + Person.DELIM + newHairColor + Person.DELIM +
