...
On va utiliser la fonction `withdrawMoney` de la classe `BankAccount`.
```java
...
On pourrait minimiser ce chiffre en créant une fonction `checkWithDrawAmount` qui retourne un bool et que l'on appellera la fonction `withdrawMoney`.
